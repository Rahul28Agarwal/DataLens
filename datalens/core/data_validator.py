...
class DataValidator:
    ...
    def __init__(self, data: pd.DataFrame) -> None:
        """Initialize the DataValidator with the DataFrame to be validated.
    ...
    def validate_is_dataframe(self) -> None:
    ...
    def validate_duplicate_columns(self) -> None:
        """Validate that the DataFrame does not contain duplicate columns.
    ...
    def validate_column(self, column: str) -> None:
        """Validate that a given column exists in the DataFrame.
